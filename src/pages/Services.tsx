...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      features: [
        "Official Meta Verified Blue Tick Badge",
        "Verified Business Display Name",
        "Enhanced Brand Trust & Credibility",
        "Higher Message Open & Response Rates",
        "Secure & Trusted Customer Communication",
        "Business Profile Verification Support",
